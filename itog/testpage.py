...
# GET TEXT
    ...
    def get_about_title_font_size(self):
        element = self.find_element(ids["LOCATOR_ABOUT_TITLE"])
        if element:
    ...
    def about_success(self):
        return self.get_text_from_element(ids["LOCATOR_ABOUT_TITLE"], description="title_about")
...
# CLICK
    ...
    def click_about_button(self):
        self.click_button(ids["LOCATOR_ABOUT_BTN"], description="about")